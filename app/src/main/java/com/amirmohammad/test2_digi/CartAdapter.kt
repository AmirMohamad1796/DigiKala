...
//
//class CartAdapter( private val product_List: List<Product>) : RecyclerView.Adapter<CartAdapter.CartViewHolder>() {
//
//
//
...
////        holder.quantity.text = "تعداد: ${product.quantity}"
//    }
//
...
//
//    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartViewHolder {
//        // به جای cart_layout از cart_item استفاده کنید
